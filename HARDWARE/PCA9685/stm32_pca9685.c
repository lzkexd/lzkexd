...
void PCA_MG9XX_Init(float hz,u8 angle)
{
	...
	pca_setpwm(4,0,off);pca_setpwm(5,0,off);pca_setpwm(6,0,off);pca_setpwm(7,30,off);
	pca_setpwm(8,0,off);pca_setpwm(9,30,off);pca_setpwm(10,0,off);pca_setpwm(11,0,off);
...
*/
void NEW78(u8 num,u8 start_angle,u8 end_angle)
{
	u32 off=0;
